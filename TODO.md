...
- [x] DB-001 Add migration framework and initial tenant schema. — completed 2026-09-05, commit bd8da31, evidence: `docs/evidence/db-001-migrations.md`; `GOCACHE=/tmp/thinkpixelmp-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-002 Add Publisher tables/domain/repository. — completed 2026-09-05, commit bd8da31, evidence: `docs/evidence/db-002-publishers.md`; `GOCACHE=/tmp/thinkpixelmp-db002-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db002-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-003 Add Namespace tables/domain/repository with tenant-scoped ownership uniqueness. — completed 2026-09-05, commit bd8da31, evidence: `docs/evidence/db-003-namespaces.md`; `GOCACHE=/tmp/thinkpixelmp-db003-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db003-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-004 Add Artifact tables/domain/repository. — completed 2026-09-05, commit bd8da31, evidence: `docs/evidence/db-004-artifacts.md`; `GOCACHE=/tmp/thinkpixelmp-db004-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db004-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-005 Add immutable ArtifactVersion tables/domain including digest, semantic version, artifact kind, delivery model, and lifecycle. — completed 2026-09-05, commit bd8da31, evidence: `docs/evidence/db-005-artifact-versions.md`; `GOCACHE=/tmp/thinkpixelmp-db005-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db005-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-006 Add database guards preventing ArtifactVersion payload/digest mutation after registration. — completed 2026-09-05, commit bd8da31, evidence: `docs/evidence/db-006-artifact-version-mutation-guards.md`; `GOCACHE=/tmp/thinkpixelmp-db006-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db006-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-007 Add ArtifactSource metadata and immutable resolved source digest/reference. — completed 2026-09-05, commit bd8da31, evidence: `docs/evidence/db-007-artifact-sources.md`; `GOCACHE=/tmp/thinkpixelmp-db007-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db007-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`

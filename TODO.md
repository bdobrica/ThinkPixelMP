...
- [x] ENG-011 Add format, vet/static, unit, race, dependency, vulnerability, license, OpenAPI, binary-build verification. — completed 2026-08-31, commit 3e01661, evidence: `docs/evidence/eng-011-verification-gate.md`; `GOCACHE=/tmp/thinkpixelmp-eng010-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] ENG-012 Add PostgreSQL development dependency and explicit migration command. — completed 2026-08-31, commit 4b7d3e0, evidence: `docs/evidence/eng-012-postgresql-development.md`; `TPMP_POSTGRES_PASSWORD=<redacted> docker compose config --quiet`; PostgreSQL 18.6 readiness/version smoke; `GOCACHE=/tmp/thinkpixelmp-eng012-go-cache GOTOOLCHAIN=go1.26.7 make migrate`; `GOCACHE=/tmp/thinkpixelmp-eng012-go-cache GOTOOLCHAIN=go1.26.7 go test -race ./cmd/migrate/...`; `GOCACHE=/tmp/thinkpixelmp-eng012-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] ENG-013 Create `thinkpixelmpctl` CLI skeleton using API client rather than direct DB access. — completed 2026-08-31, commit bd3c30e, evidence: `docs/evidence/eng-013-api-cli.md`; `GOCACHE=/tmp/thinkpixelmp-eng013-go-cache GOTOOLCHAIN=go1.26.7 go test -race ./cmd/thinkpixelmpctl/...`; `GOCACHE=/tmp/thinkpixelmp-eng013-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] ENG-014 Create baseline hardened non-root `thinkpixelmp` container image. — completed 2026-08-31, commit 6918986, evidence: `docs/evidence/eng-014-container-image.md`; `GOCACHE=/tmp/thinkpixelmp-eng014-go-cache GOTOOLCHAIN=go1.26.7 go test -race ./test/architecture/...`; hardened runtime `/livez` smoke; `GOCACHE=/tmp/thinkpixelmp-eng013-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `make image`; `git diff --check`
- [x] ENG-015 Add CI with least-privilege jobs and immutable action/version pins where practical. — completed 2026-08-31, commit 1aa4120, evidence: `docs/evidence/eng-015-continuous-integration.md`; `GOCACHE=/tmp/thinkpixelmp-eng015-go-cache GOTOOLCHAIN=go1.26.7 go test -race ./test/architecture/...`; `npm ci --ignore-scripts`; `GOCACHE=/tmp/thinkpixelmp-eng013-go-cache GOTOOLCHAIN=go1.26.7 make verify`; hardened image `/livez` smoke; `git diff --check`
- [x] ENG-016 Add repository hygiene checks preventing registry credentials, signing keys, OIDC tokens, private evidence, and test secrets from being committed. — completed 2026-09-01, commit 7d7a74b, evidence: `docs/evidence/eng-016-repository-hygiene.md`; `GOCACHE=/tmp/thinkpixelmp-eng016-go-cache GOTOOLCHAIN=go1.26.7 go test -race ./scripts/repositoryhygiene`; `GOCACHE=/tmp/thinkpixelmp-eng016-final-go-cache GOTOOLCHAIN=go1.26.7 make repository-hygiene`; repository-local-cache `GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] ENG-017 Start `docs/supported-versions.md`. — completed 2026-09-01, commit a25226d, evidence: `docs/evidence/eng-017-supported-versions.md`; `GOCACHE=/tmp/thinkpixelmp-eng017-go-cache GOTOOLCHAIN=go1.26.7 make contracts repository-hygiene`; repository-local-cache `GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] ENG-018 Verify clean checkout baseline with generation, formatting, static checks, unit/race, OpenAPI, vulnerability/license, build, and image smoke. — completed 2026-09-01, commit 4be1cd2, evidence: `docs/evidence/eng-018-clean-checkout-baseline.md`; clean checkout `make generate fmt` with no tracked diff; repository-local-cache `GOTOOLCHAIN=go1.26.7 make verify`; hardened image `/livez` and runtime-controls smoke; `git diff --check`
- [x] ENG-019 Publish `docs/phase-1-evidence.md` and commit Phase 1. — completed 2026-09-01, commit f37986c, evidence: `docs/phase-1-evidence.md`; repository-local-cache `GOTOOLCHAIN=go1.26.7 make verify`; evidence-link validation; `git diff --check`

---

## Phase 2 — Authoritative persistence, identity, and publication state

- [x] DB-001 Add migration framework and initial tenant schema. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-001-migrations.md`; `GOCACHE=/tmp/thinkpixelmp-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-002 Add Publisher tables/domain/repository. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-002-publishers.md`; `GOCACHE=/tmp/thinkpixelmp-db002-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db002-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-003 Add Namespace tables/domain/repository with tenant-scoped ownership uniqueness. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-003-namespaces.md`; `GOCACHE=/tmp/thinkpixelmp-db003-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db003-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-004 Add Artifact tables/domain/repository. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-004-artifacts.md`; `GOCACHE=/tmp/thinkpixelmp-db004-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db004-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-005 Add immutable ArtifactVersion tables/domain including digest, semantic version, artifact kind, delivery model, and lifecycle. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-005-artifact-versions.md`; `GOCACHE=/tmp/thinkpixelmp-db005-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db005-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-006 Add database guards preventing ArtifactVersion payload/digest mutation after registration. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-006-artifact-version-mutation-guards.md`; `GOCACHE=/tmp/thinkpixelmp-db006-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db006-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-007 Add ArtifactSource metadata and immutable resolved source digest/reference. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-007-artifact-sources.md`; `GOCACHE=/tmp/thinkpixelmp-db007-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db007-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-008 Add ArtifactDescriptor persistence using bounded normalized metadata. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-008-artifact-descriptors.md`; `GOCACHE=/tmp/thinkpixelmp-db008-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db008-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-009 Add ArtifactRequirement persistence. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-009-artifact-requirements.md`; `GOCACHE=/tmp/thinkpixelmp-db009-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db009-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-010 Add ArtifactDependency persistence. — completed 2026-09-05, commit 6cce195, evidence: `docs/evidence/db-010-artifact-dependencies.md`; `GOCACHE=/tmp/thinkpixelmp-db010-go-cache GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOCACHE=/tmp/thinkpixelmp-db010-go-cache GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
...
- [x] PUB-005 Implement ArtifactVersion registration skeleton requiring immutable digest/source data. — completed 2026-09-06, evidence: `docs/evidence/pub-005-artifact-version-registration.md`; `GOTOOLCHAIN=go1.26.7 go test -race ./internal/app/publication ./internal/domain/artifactversion ./internal/domain/artifactsource`; `GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-016 Add migration-from-empty tests against real pinned PostgreSQL. — completed 2026-09-06, evidence: `docs/evidence/db-016-migration-from-empty.md`; `GOTOOLCHAIN=go1.26.7 go test -count=1 -race -tags=dbintegration -run 'TestPostgres/migration_from_empty' ./internal/adapters/postgres/migration`; `GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-017 Add tenant-isolation tests across all repositories. — completed 2026-09-06, evidence: `docs/evidence/db-017-tenant-isolation.md`; `GOTOOLCHAIN=go1.26.7 go test -count=1 -race -tags=dbintegration -run 'TestPostgres/(publisher_repository|namespace_repository|artifact_repository|artifact_version_repository|idempotency_repository|outbox_repository)' ./internal/adapters/postgres/migration`; `GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
- [x] DB-018 Add concurrent namespace/artifact/version registration tests. — completed 2026-09-06, evidence: `docs/evidence/db-018-concurrent-registration.md`; `GOTOOLCHAIN=go1.26.7 go test -count=3 -race -tags=dbintegration -run 'TestPostgres/concurrent_identity_registration' ./internal/adapters/postgres/migration`; `GOTOOLCHAIN=go1.26.7 make test-migrations`; `GOTOOLCHAIN=go1.26.7 make verify`; `git diff --check`
